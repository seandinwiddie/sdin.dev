<?xml version="1.0" encoding="UTF-8"?>
	...
	<xsl:template match="/">
		...
		<head>
			<title>XML Sitemap - sdin.dev</title>
		...
		<body>
		<div id="content">
			<h1>XML Sitemap - sdin.dev</h1>
			<p class="expl">
				Generated for <a href="https://sdin.dev" target="_blank" rel="noopener">sdin.dev</a>, this is an XML Sitemap, meant for consumption by search engines.<br/>
